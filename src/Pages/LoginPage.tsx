...
const LoginPage: React.FC = () => {
  ...
  const handleGuestLogin = async () => {
    const response = await loginUser('guest53@example.com', 'root1234');
        ...
        >
          ...
          {isRegistering && (
            ...
            <button
              ...
              className="w-full py-3 bg-emerald-600 text-white rounded-md hover:bg-emerald-400 focus:ring-2 focus:ring-maroon-500"
            >
          ...
          <div>
            <button
              type="submit"
              className="w-full py-3 bg-maroon-600 text-white rounded-md hover:bg-maroon-700 hover:underline focus:outline-none focus:ring-2 focus:ring-maroon-500"
            >
