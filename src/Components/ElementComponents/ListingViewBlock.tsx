                    ...
                    {(bidsCount > 0) && (
                        <div className="flex justify-between w-full p-2 bg-pink-300 rounded-sm">
                            ...
                            <div className="flex justify-between items-center w-[35%]">
                                ...
                                <p className="w-[45%] p-1 text-white overflow-hidden text-ellipsis bg-pink-500 rounded-sm">{bestBidUserName}</p>
                            </div>
                        </div>
                    )}
                    
                    <button className="p-2 rounded-sm bg-emerald-400 hover:bg-emerald-500 text-white" onClick={() => {}}>View Listing</button>
                </div>
            </div>
        </div>
    );
